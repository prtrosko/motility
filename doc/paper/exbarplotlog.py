...
N = 4
Tata = map(math.log10, (0.04, 3.1, 104, 88.8))
Small = map(math.log10, (0.06, 3.0, 105, 142.3))
Medium = map(math.log10, (0.04, 2.9, 103, 197.9))
Large = map(math.log10, (0.11, 2.9, 104, 277.3))
Vlarge = map(math.log10, (0.07, 2.9, 103, 753.3))
